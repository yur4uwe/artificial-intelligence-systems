...
export function createDirectedPreset(): GraphData {
    ...
    // Re-orient edges and add bottom-up arcs for rich non-crossing graph traversal
    const directedEdges: GraphEdge[] = [
        ...
        { id: 'd-4-3', from: 4, to: 3, isDirected: true },
