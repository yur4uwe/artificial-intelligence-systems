...
export type BFSStepEvent = StepEvent
...
class BFSAlgorithm implements RunnableAlgorithm<BFSStepEvent> {}
...
export function* runBFS(
    options: BFSOptions
): Generator<StepEvent, LabMetrics, unknown> {
    const { model, startId, goalId, sortingStrategy } = options
